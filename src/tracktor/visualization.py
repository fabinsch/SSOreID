...
class VisdomLinePlotter(object):
    ...
    def plot(self, var_name, split_name, title_name, x, y, erase=False, train_positive=False, val_positive=False, val_negative=False):
        if train_positive:
            ...
            color = np.array([[0, 0, 128], ])#dark blue
