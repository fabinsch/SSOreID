...
def nms(detections, regression_nms_threshold):
	"""

	Parameters
	----------
	detections List: A list of proposal boxes and their corresponding confidence scores
	regression_nms_threshold Integer: The overlap threshold

	Returns
	A list of filtered proposals
	-------
