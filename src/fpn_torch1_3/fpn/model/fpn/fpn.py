...
from helper.csrc.wrapper.roi_pool import ROIPool
from helper.csrc.wrapper.roi_align import ROIAlign
...
class _FPN(nn.Module):
    ...
    def __init__(self, classes):
        ...
        self.RCNN_roi_align = ROIAlign(cfg.POOLING_SIZE, cfg.POOLING_SIZE, 1.0/16.0)
